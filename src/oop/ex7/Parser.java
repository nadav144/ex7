...
public class Parser {
	...
	public ValidationResult Parse( String filename, Scope scope ) {
		...
		/*
		 * // GetFile Content. // For each line - // Match the pattern and
		 * create "Scope/Assignment/.... - CommandType
		 * 
		 * if i got scope, read to parse again
		 * 
		 * ELSE
		 * 
		 * Create new validator for that line validate current line - recursive
		 * (CommandValidator.Validate(Command, Scope)) update scope information
		 * 
		 * if End of Scope exit function iteration - return to parent scope.
		 */
